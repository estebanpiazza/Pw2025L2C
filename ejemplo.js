...
document.getElementById("ultimoDado").innerText="Último dado:"
// Limpiar porcentajes
for(let i = 2; i <= 12; i++) {
  document.getElementById("porcentaje" + i).innerText = "0%"
}
document.getElementById("totalLanzamientos").innerText = "Total de lanzamientos: 0"
// Limpiar tabla de recolectas
document.getElementById("Recolectas").innerText = "Recolectas:"
...
window.onload = function cargarDatos() {
  ...
  // Inicializar localStorage si es la primera vez
  if (localStorage.getItem("cantidad2") === null) {
    for(let i = 2; i <= 12; i++) {
      localStorage.setItem("cantidad" + i, "0")
    }
  }
  ...
  // Cargar cantidades de dados con valores por defecto si no existen
  document.getElementById("cantidad2").innerText= localStorage.getItem("cantidad2") || "0"
  document.getElementById("cantidad3").innerText=localStorage.getItem("cantidad3") || "0"
  document.getElementById("cantidad4").innerText=localStorage.getItem("cantidad4") || "0"
  document.getElementById("cantidad5").innerText=localStorage.getItem("cantidad5") || "0"
  document.getElementById("cantidad6").innerText=localStorage.getItem("cantidad6") || "0"
  document.getElementById("cantidad7").innerText=localStorage.getItem("cantidad7") || "0"
  document.getElementById("cantidad8").innerText=localStorage.getItem("cantidad8") || "0"
  document.getElementById("cantidad9").innerText=localStorage.getItem("cantidad9") || "0"
  document.getElementById("cantidad10").innerText=localStorage.getItem("cantidad10") || "0"
  document.getElementById("cantidad11").innerText=localStorage.getItem("cantidad11") || "0"
  document.getElementById("cantidad12").innerText=localStorage.getItem("cantidad12") || "0"

  // Actualizar porcentajes después de cargar los datos
